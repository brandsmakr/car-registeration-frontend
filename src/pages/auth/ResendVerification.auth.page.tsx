...
const ResendVerification = () => {
  ...
  const handleVerification = () => {
    ...
    Services.Auth.ResendVerificationEmail(data)
      .then((res: any) => {
        setIsLoading(false);
          if (res.success) {
            return navigate("/resend-verification");
          } else {
          ...
          <Container component="main" maxWidth="xs">
            ...
            >
              ...
              >
                ...
                {/* <Grid item>
                  <Link href="/signup" variant="body2" sx={{color: "var(--main-color)", textDecoration: "none"}}>
